...
def upgrade():
    ...
    # seller_name already exists from a prior migration — skip
    ...
    op.add_column("invoices", sa.Column("payment_method",   sa.String(32),   nullable=True))


def downgrade():
    for col in ["invoice_origin", "seller_country", "currency",
                "vat_rate", "receipt_number", "card_last4", "payment_method"]:
